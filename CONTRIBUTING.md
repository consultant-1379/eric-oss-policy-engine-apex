# Contributing to Adaptive Policy Execution is a lightweight engine for execution of policies. Policies are triggered by incoming events then logic of policies executes and produces a response event.
