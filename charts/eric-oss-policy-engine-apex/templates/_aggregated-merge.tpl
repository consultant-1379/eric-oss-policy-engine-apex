...
*/ -}}
{{- define "eric-oss-policy-engine-apex.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-policy-engine-apex.mergeAnnotations" -}}
  {{- include "eric-oss-policy-engine-apex.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-policy-engine-apex.mergeLabels" -}}
  {{- include "eric-oss-policy-engine-apex.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
